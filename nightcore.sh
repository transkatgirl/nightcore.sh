...
[1:v]format=pix_fmts=gbrp,loop=loop=-1:size=1,fps=fps=24,crop=3840:2160:$filterx:$filtery,$atext,fps=fps=60[background];
[background][visualizer]overlay=shortest=1:x=0:y=1080:eval=init:format=gbrp" # gliding background is rendered at 24fps for a more "cinematic" look, a smooth 60fps glide is too distracting
